...
状態: `[DRAFT]` `[0.2.0 DESIGN LINE]` `[1.x TARGET]`
...
|---|---|---|---|
| [SphereOS Atlantis](https://github.com/saitoomituru/SphereOS-Atlantis) | 0.2.0 bootstrapping／Prompt Engineering Edition | 開発環境、World orchestration契約、agent deck、doctor、SDK bundle | standalone Atlantis runtime |
