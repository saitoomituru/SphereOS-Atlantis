...
upstream: `ZeroRoomLab-manifest@010cf1c7ef28c14657c69bfaf5732183a1fc0ff5`
...
Worldだけ、またはInstance Ghostだけをsplitして元世界線へ片側を共有しない。7DはWorld、Instance Ghost、
Temporal Coordinate、Observation-Evidence、Branch-Hypothesis、Provenance、Recovery-RestoreというContext
Dimensionのarityであり、物理次元数ではない。
...
- [Atlantis-MAGISDK 0.2.1](https://github.com/saitoomituru/ZeroRoomLab-manifest/blob/010cf1c7ef28c14657c69bfaf5732183a1fc0ff5/docs/theory/atlantis-magi-sdk-0.2.1.ja.md)
