...
1. `python3 magi/0.2.1/resolve_sources.py --slot chikuwa-cannon`を実行する。
...
7. 過去OAE不明を未来projectionで埋めない。Akasha Driver、7D Fold、Kamui、backup SDKは、実装receiptが
   ない限り`PROSPECTIVE / NOT_IMPLEMENTED`へ置く。
